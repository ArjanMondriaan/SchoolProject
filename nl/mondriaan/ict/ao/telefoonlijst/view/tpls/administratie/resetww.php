...
include 'includes/menu.php';?>
    <section id='content'>
        <table id="contacten">
            ...
            <thead>
                <tr><td>foto</td><td>naam</td><td>email</td><td>intern</td><td>extern</td><td>afd</td><td colspan="4">acties</td></tr>
            </thead>
            <?php foreach($contacten as $contact):?>
                <tr>
                    ...
                    <td title="verwijder dit contact definitief"><a href='?control=secretaresse&action=delete&id=<?= $contact->getId();?>'><img src="img/verwijder.png"></a></td>
                        ...
                        <?php endforeach;?>
                <tr><td><a href='?control=secretaresse&action=add'><figure><img src="img/toevoegen.png" alt='voeg een contact toe image' title='voeg een contact toe'></figure></a></td><td colspan='9'>voeg een contact aan de school toe</td></tr>
        </table>
        <br id ="breaker">
    </section>
